...
with app.app_context():
    ...
    notifs = [
        Notification(id_utilisateur=raf.id,
                     ...
                     message='Le budget Informatique est consommé à 81%.',
    ...
    messages = [
        Message(id_expediteur=raf.id, id_destinataire=comptable.id,
                ...
                contenu='Merci de valider la dépense informatique avant vendredi.',
        ...
        Message(id_expediteur=comptable.id, id_destinataire=raf.id,
                ...
                contenu='Le rapport du mois de Mai est prêt. Total encaissé : 1 430 000 FCFA.',
    ...
    print("✅ SEED COMPLET — Base de données prête pour la démo !")
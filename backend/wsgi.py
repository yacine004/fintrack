...
with app.app_context():
    ...
    # ── Barème ISM 2025-2026 ──────────────────────────────────────────────
    # Inscription : 4 × 112 500 = 450 000 FCFA
    # Scolarité L1/L2/L3 : 10 × 95 000 = 950 000 FCFA
    # Scolarité M1 : 10 × 100 000 ; M2 : 10 × 97 500
    # Encadrement L3 : 75 000 FCFA (mars)
    # ─────────────────────────────────────────────────────────────────────

    # e1 : Mamadou Diallo — L3 GLRS — 4 tranches inscription + 8 mensualités + encadrement
    paiements_e1 = [
    ...
    # e2 : Fatou Sarr — L3 CDSD — 2 tranches + 3 mensualités (retard)
    paiements_e2 = [
    ...
    # e3 : Ousmane Ndiaye — L2 GLRS — 2 tranches + 3 mensualités (en cours)
    paiements_e3 = [
    ...
    # e4 : Aminata Ba — L1 CDSD — 1 tranche seulement (retard important)
    paiements_e4 = [
    ...
    # e5 : Ibrahim Kone — L3 GLRS — presque tout payé (4 inscriptions + 9 mensualités + encadrement)
    paiements_e5 = [
    ...
    # e6 : Marieme Fall — L2 GLRS — 4 inscriptions + 4 mensualités (à jour)
    paiements_e6 = [
    ...
    db.session.add_all([
        ...
        Notification(id_utilisateur=raf.id_utilisateur,
            type='paiement',
            message='Paiement 95 000 FCFA pour Kone Ibrahim (Mensualite Mai 2026).',
    ...
    db.session.add_all([
        ...
        Message(id_expediteur=comptable.id_utilisateur,
            ...
            contenu='Rapport Mai pret. Total encaisse 4 617 500 FCFA.',

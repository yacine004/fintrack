...
with app.app_context():
    ...
    if db.session.query(Utilisateur).count() > 0:
        print('SEED SKIP: donnees existantes')
    else:
        print('Tables initialisees — seed en cours...')
        ...
        # e1 : Mamadou Diallo — L3 GLRS — 4 tranches + 8 mensualités + encadrement
        paiements_e1 = [
        ...
        # e4 : Aminata Ba — L1 CDSD — 1 tranche + 1 mensualité (retard important)
        paiements_e4 = [
        ...
        # e5 : Ibrahim Kone — L3 GLRS — 4 tranches + 9 mensualités + encadrement
        paiements_e5 = [
        ...
        # e6 : Marieme Fall — L2 GLRS — 4 tranches + 4 mensualités (a jour)
        paiements_e6 = [

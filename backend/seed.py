...
def seed():
    with app.app_context():
        ...
        etudiants_data = [
            ('ISM2526/DK-00001','Diallo',   'Mamadou',    'm.diallo@ism.edu.sn',   '77 111 11 11','L3','GLRS'),
            ('ISM2526/DK-00002','Sarr',     'Fatou',      'f.sarr@ism.edu.sn',     '77 222 22 22','L3','MIAGE'),
            ('ISM2526/DK-00003','Ndiaye',   'Ousmane',    'o.ndiaye@ism.edu.sn',   '77 333 33 33','L2','GLRS'),
            ('ISM2526/DK-00004','Ba',       'Aminata',    'a.ba@ism.edu.sn',       '77 444 44 44','L1','TTL'),
            ('ISM2526/DK-00005','Koné',     'Ibrahim',    'i.kone@ism.edu.sn',     '77 555 55 55','L3','MAIE'),
            ('ISM2526/DK-00006','Traoré',   'Aïssatou',   'a.traore@ism.edu.sn',   '77 666 66 66','L2','ETSE'),
            ('ISM2526/DK-00007','Camara',   'Lamine',     'l.camara@ism.edu.sn',   '77 777 77 77','L1','GLRS'),
            ('ISM2526/DK-00008','Sow',      'Mariama',    'm.sow@ism.edu.sn',      '77 888 88 88','M1','MBA/DIA'),
            ('ISM2526/DK-00009','Mbaye',    'Cheikh',     'c.mbaye@ism.edu.sn',    '77 999 99 99','M1','MBI/MSSI'),
            ('ISM2526/DK-00010','Diouf',    'Rokhaya',    'r.diouf@ism.edu.sn',    '76 100 10 10','L3','MOSIEF'),
            ('ISM2526/DK-00011','Gaye',     'Moustapha',  'm.gaye@ism.edu.sn',     '76 110 11 11','L2','IA'),
            ('ISM2526/DK-00012','Fall',     'Ndèye',      'n.fall@ism.edu.sn',     '76 120 12 12','L1','CS'),
            ('ISM2526/DK-00013','Diop',     'Amadou',     'a.diop2@ism.edu.sn',    '76 130 13 13','M2','MBA/ABDAQ'),
            ('ISM2526/DK-00014','Touré',    'Kadiatou',   'k.toure@ism.edu.sn',    '76 140 14 14','L3','GLRS'),
            ('ISM2526/DK-00015','Balde',    'Ibrahima',   'i.balde@ism.edu.sn',    '76 150 15 15','L2','MIAGE'),
            ('ISM2526/DK-00016','Cissé',    'Coumba',     'c.cisse@ism.edu.sn',    '76 160 16 16','L1','TTL'),
            ('ISM2526/DK-00017','Kane',     'Seydou',     's.kane@ism.edu.sn',     '76 170 17 17','M1','MBI/MIRSD'),
            ('ISM2526/DK-00018','Diagne',   'Fatima',     'f.diagne@ism.edu.sn',   '76 180 18 18','L3','ETSE'),
            ('ISM2526/DK-00019','Badji',    'Oumar',      'o.badji@ism.edu.sn',    '76 190 19 19','L2','MAIE'),
            ('ISM2526/DK-00020','Mendy',    'Aïda',       'a.mendy@ism.edu.sn',    '76 200 20 20','L1','CS'),
            ('ISM2526/DK-00021','Bodian',   'Serigne',    's.bodian@ism.edu.sn',   '76 210 21 21','L3','IA'),
            ('ISM2526/DK-00022','Dème',     'Sokhna',     's.deme@ism.edu.sn',     '76 220 22 22','M1','MMP'),
            ('ISM2526/DK-00023','Faye',     'Aliou',      'al.faye@ism.edu.sn',    '76 230 23 23','L2','GLRS'),
            ('ISM2526/DK-00024','Ndour',    'Mame Diarra', 'm.ndour@ism.edu.sn',   '76 240 24 24','M2','MMPI'),
            ('ISM2526/DK-00025','Tamba',    'Babacar',    'b.tamba@ism.edu.sn',    '76 250 25 25','L3','MOSIEF'),
            ('ISM2526/DK-00026','Diallo',   'Boubacar',   'b2.diallo@ism.edu.sn',  '76 260 26 26','L2','MIAGE'),
            ('ISM2526/DK-00027','Seck',     'Aminata',    'am.seck@ism.edu.sn',    '76 270 27 27','L1','MAIE'),
            ('ISM2526/DK-00028','Thiaw',    'Modou',      'm.thiaw@ism.edu.sn',    '76 280 28 28','L3','CS'),
            ('ISM2526/DK-00029','Diatta',   'Marie',      'ma.diatta@ism.edu.sn',  '76 290 29 29','M1','MBA/DIA'),
            ('ISM2526/DK-00030','Mané',     'Oumar',      'o.mane@ism.edu.sn',     '76 300 30 30','L2','ETSE'),
            ('ISM2526/DK-00031','Coly',     'Augustin',   'a.coly@ism.edu.sn',     '76 310 31 31','L1','GLRS'),
            ('ISM2526/DK-00032','Tendeng',  'Rokhaya',    'r.tendeng@ism.edu.sn',  '76 320 32 32','M2','MBI/MSSI'),
            ('ISM2526/DK-00033','Sané',     'Lamine',     'la.sane@ism.edu.sn',    '76 330 33 33','L3','TTL'),
            ('ISM2526/DK-00034','Badji',    'Maimouna',   'mai.badji@ism.edu.sn',  '76 340 34 34','M1','MMPI'),
            ('ISM2526/DK-00035','Sambou',   'Arfang',     'a.sambou@ism.edu.sn',   '76 350 35 35','L2','IA'),
        ]
        ...
        messages = [
            ...
            (comptable.id_utilisateur, raf.id_utilisateur,
             'Étudiant ISM2526/DK-00013 — Solde impayé S2',
             'Bonjour, l\'étudiant Amadou Diop (ISM2526/DK-00013) n\'a pas encore réglé ses frais '
        ...
        notifs = [
            ...
            (raf.id_utilisateur, 'paiement', 'normale',  False,
             'Nouveau paiement de 750 000 FCFA — Cheikh Mbaye (ISM2526/DK-00009)'),
            ...
            (raf.id_utilisateur, 'paiement', 'normale',  True,
             'Paiement de 1 500 000 FCFA enregistré — Mame Diarra Ndour (ISM2526/DK-00024)'),
            (raf.id_utilisateur, 'budget',   'critique', True,
             'Budget "Evenements" consommé à 55% — 180 000 FCFA restants'),
            (raf.id_utilisateur, 'paiement', 'normale',  True,
             'Paiement de 500 000 FCFA enregistré — Mamadou Diallo (ISM2526/DK-00001)'),
            # Comptable
            (comptable.id_utilisateur, 'paiement', 'normale', False,
             'Nouveau paiement Mobile Money 350 000 FCFA — Fatou Sarr (ISM2526/DK-00002)'),
            ...
            (comptable.id_utilisateur, 'paiement', 'normale', True,
             'Paiement de 200 000 FCFA enregistré — Babacar Tamba (ISM2526/DK-00025)'),
        ]
        ...
        audits = [
            ...
            (comptable.id_utilisateur, 'CREATION',   'paiement', 1,    'Paiement 500 000 FCFA — ISM2526/DK-00001 Mamadou Diallo'),
            (comptable.id_utilisateur, 'CREATION',   'paiement', 2,    'Paiement 750 000 FCFA — ISM2526/DK-00002 Fatou Sarr'),
            ...
            (comptable.id_utilisateur, 'CREATION',   'paiement', 8,    'Paiement 1 000 000 FCFA — ISM2526/DK-00008 Mariama Sow'),
